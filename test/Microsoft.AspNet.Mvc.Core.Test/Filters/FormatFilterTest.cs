...
namespace Microsoft.AspNet.Mvc
{
    public class FormatFilterTests
    {
        ...
        public class MockObjects
        {
            ...
            {
                var httpContext = new Mock<HttpContext>();
                var mockServiceProvider = CreateMockServiceProvider(httpContext, format, place);
                ...
                FormatSource? place = null)
            {
                ...
                serviceProvider
                    .Setup(s => s.GetService(typeof(FormatFilter)))
                    .Returns(() => new FormatFilter(mvcOptions.Object, scopedInstance.Object));
